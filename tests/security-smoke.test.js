...
(async () => {
  try {
    ...
    const register = await request('/api/auth/register', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ name: 'Security Patient', email, phone: '9876543210', age: 31, password, role: 'patient' }) });
